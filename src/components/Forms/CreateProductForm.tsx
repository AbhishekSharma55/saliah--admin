...
const CreateUpdateForm = ({
    ...
    const onSubmit = async (values: z.infer<typeof ProductZodSchema>) => {
        try {
            ...
            const { data } = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/products`, formateData)
                        ...
                        <div className="col-span-1 md:col-span-2  lg:col-span-3">
                            ...
                            <div className=" flex flex-col">
                                {fields.map((field, index) => {
                                    return (
                                        <div key={index} className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                                            <FormField
                                                key={index}
                                                control={form.control}
